...
namespace Prodi\SafetyBundle\Entity;
...
/**
 * @ORM\Entity(repositoryClass="Prodi\SafetyBundle\Repository\UserRepository")
...
//            return false;
     ...
     * Add user_roles
     *
     * @param Prodi\SafetyBundle\Entity\Role $userRoles
     */
    public function addRole(\Prodi\SafetyBundle\Entity\Role $userRoles) {
...
//Para apptibasse    
     ...
     * @return User
     */
    public function addUserRole(\Prodi\SafetyBundle\Entity\Role $userRoles)
    {
        $this->user_roles[] = $userRoles;
     ...
     * @param \Prodi\SafetyBundle\Entity\Role $userRoles
     */
    public function removeUserRole(\Prodi\SafetyBundle\Entity\Role $userRoles)
    {
